...
public class QRCodeReaderView extends SurfaceView
    ...
    private com.dlazaro66.qrcodereaderview.QRCodeReaderView.OnQRCodeReadListener mOnQRCodeReadListener;

    private static final String TAG = com.dlazaro66.qrcodereaderview.QRCodeReaderView.class.getName();
    ...
    private com.example.hackathon.util.ui.QRCodeReaderView.DecodeFrameTask decodeFrameTask;
    private Map<DecodeHintType, Object> decodeHints;
    private int face = Camera.CameraInfo.CAMERA_FACING_BACK;
     ...
     */
    public void setOnQRCodeReadListener(com.dlazaro66.qrcodereaderview.QRCodeReaderView.OnQRCodeReadListener onQRCodeReadListener) {
    ...
    @Override public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        decodeFrameTask = new com.example.hackathon.util.ui.QRCodeReaderView.DecodeFrameTask(this, decodeHints);
    ...
    private static class DecodeFrameTask extends AsyncTask<byte[], Void, Result> {
        ...
        private final WeakReference<com.example.hackathon.util.ui.QRCodeReaderView> viewRef;
        ...
        public DecodeFrameTask(com.example.hackathon.util.ui.QRCodeReaderView view, Map<DecodeHintType, Object> hints) {
            viewRef = new WeakReference<>(view);
            hintsRef = new WeakReference<>(hints);
        }

        @Override protected Result doInBackground(byte[]... params) {
            final com.example.hackathon.util.ui.QRCodeReaderView view = viewRef.get();
            if (view == null) {
                return null;
            }
         ...
         */
        private PointF[] transformToViewCoordinates(com.example.hackathon.util.ui.QRCodeReaderView view, ResultPoint[] resultPoints) {
